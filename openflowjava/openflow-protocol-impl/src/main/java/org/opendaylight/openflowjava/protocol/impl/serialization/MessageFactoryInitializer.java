...
//IROF yuhao
import org.opendaylight.openflowjava.protocol.impl.serialization.factories.TopoRequestInputMessageFactory;
...
public final class MessageFactoryInitializer {
    ...
    public static void registerMessageSerializers(SerializerRegistry serializerRegistry) {
        ...
        //IROF yuhao----------------------------------------------------------------------------
        registryHelper.registerSerializer(TopoRequestInput.class, new TopoRequestInputMessageFactory());
