...
//IROF yuhao
import org.opendaylight.openflowjava.protocol.impl.deserialization.factories.IrofFeaturesReplyMessageFactory;
...
public final class MessageDeserializerInitializer {
    ...
    public static void registerMessageDeserializers(DeserializerRegistry registry) {
        ...
        //IROF yuhao
        helper.registerDeserializer(59, null, FeatureReplyMessage.class, new IrofFeaturesReplyMessageFactory());
    }
}
