...
public class ConnectionAdapterImpl extends AbstractConnectionAdapterStatistics implements ConnectionFacade {
    ...
    public void consumeDeviceMessage(final DataObject message) {
        ...
        if (message instanceof Notification) {
            ...
            //IROF yuhao
            else if (message instanceof FeatureReplyMessage) {
                LOG.info("======Run onFeatureReplyMeesage() in openflow-protocol-impl=====");
                messageListener.onFeatureReplyMessage((FeatureReplyMessage) message);
            }
            //yuhao
