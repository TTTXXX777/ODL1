...
public class MypacketProvider {
    ...
    public void init() {
        ...
        SendPacket.packetSetConfigService = rpcRegistry.getRpcService(PacketSetConfigService.class);
        
        mypacketService = rpcRegistry.addRpcImplementation(MypacketService.class, new MypacketImpl());
    }
